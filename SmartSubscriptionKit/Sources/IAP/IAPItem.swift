//
//  SmartSubscriptionIAPItem.swift
//
//
...
public struct SmartSubscriptionIAPItem {
...
extension SmartSubscriptionIAPItem: Identifiable {
    ...
    static let mockCoffee = SmartSubscriptionIAPItem(
        product: .init(),
    ...
    static let mockBeer = SmartSubscriptionIAPItem(
        product: .init(),
        title: "A beer",
